...
class Coin:
    ...
    def print_coin(self):
        print("-----")
        print(f"{self.value} Cent - Color: {self.color}, Value: {self.value}, Diameter (mm): {self.diameter}, Thickness (mm): {self.thickness}, Edges: {self.edges}, Mass: {self.mass}")
...
for coin in coins: coin.print_coin()
